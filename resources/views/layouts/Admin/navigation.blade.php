<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  <div class="app-brand demo">
    <a href="{{ route('Home') }}" class="app-brand-link">
      ...
      <span class="app-brand-text demo menu-text fw-bolder ms-2">WebProfile</span>
    </a>
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-header small text-uppercase">
      <span class="menu-header-text">Admin Public Content</span>
    </li>

    <li class="menu-item {{ request()->routeIs('jumbotron.*') ? 'active' : '' }}">
      <a href="{{ route('jumbotron.index') }}" class="menu-link">
        <div data-i18n="Boxicons">Jumbotron</div>
      </a>
    </li>
    <li class="menu-item {{ request()->routeIs('abouts.*') ? 'active' : '' }}">
      <a href="{{ route('abouts.index') }}" class="menu-link">
        <div data-i18n="Boxicons">About</div>
      </a>
    </li>
    <li class="menu-item {{ request()->routeIs('portofolio.*') ? 'active' : '' }}">
      <a href="{{ route('portofolio.index') }}" class="menu-link">
        <div data-i18n="Boxicons">Portofolio</div>
      </a>
    </li>
    ...
    <li class="menu-item {{ request()->routeIs('footer.*') ? 'active' : '' }}">
      <a href="{{ route('footer.index') }}" class="menu-link">
        <div data-i18n="Boxicons">Footer</div>
      </a>
    </li>
  </ul>
</aside>
